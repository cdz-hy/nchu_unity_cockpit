...
public class DoorLControl : MonoBehaviour
{
    ...
    private IEnumerator OpenDoorCoroutine()
    {
        ...
        Vector3 outerPosition = targetInnerPosition + transform.right * 0.3f + transform.forward * 0.4f;
    ...
    private IEnumerator CloseDoorCoroutine()
    {
        ...
        // 先到边缘位置   
        Vector3 positionAfterPush = initialPosition - transform.right * 0.02f + transform.forward * 0.01f;
