...
public class EngineRotation2: MonoBehaviour
{

    // 最大旋转速度（单位：度/秒）
    public float maxRotationSpeed = 1800f; // 每秒旋转1800度
    ...
    void Update()
    {
        ...
        float throttleLever = Mathf.Clamp01(DataCenter.Instance.throttleLever2);
